                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/US.png" </div>
                                </td>
                                <td>USA</td>
                                <td class="text-right">
                                  2.920
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/DE.png" </div>
                                </td>
                                <td>Germany</td>
                                <td class="text-right">
                                  1.300
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/AU.png" </div>
                                </td>
                                <td>Australia</td>
                                <td class="text-right">
                                  760
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/GB.png" </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/RO.png" </div>
                                </td>
                                <td>Romania</td>
                                <td class="text-right">
                                  600
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img src="/php_tutorial/assets/img/flags/BR.png" </div>
                                </td>
                                <td>Brasil</td>
                                <td class="text-right">
                                  550
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/php_tutorial/assets/img/sidebar-1.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/php_tutorial/assets/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/php_tutorial/assets/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="/php_tutorial/assets/img/sidebar-4.jpg" alt="">
          </a>
        </li>
